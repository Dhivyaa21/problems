...
class GraphWithPathCompression
{
    int V, E;
    Edge[] edge;

    GraphWithPathCompression(int nV, int nE)
    {
        V = nV;
        E = nE;
        edge = new Edge[E];
...
// a given graph contains cycle or not
    int isCycle(GraphWithPathCompression graph)
    {
        int V = graph.V;
        int E = graph.E;
...
/* Let us create the following graph
	...
	1-----2 */
        ...
        int V = 3, E = 3;
        GraphWithPathCompression graph = new GraphWithPathCompression(V, E);
